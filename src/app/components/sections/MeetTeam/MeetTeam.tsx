  ...
  const teamMembers = [
    {
      ...
      description: [
        "My developer journey first started when a friendly customer approached while I was bartending in my early 20's suggesting that I give coding a try. From the minute I wrote my first line of code, I completely fell in love and have pursued web development to it's fullest. I've worked in SaaS & Marketing agencies where I've had the pleasure of working with clients such as Meta, Amazon, Twilio, and S&P Global, building cutting edge Marketo, SFMC, Hubspot, and Pardot email & landing page templates.",
    ...
    },
    {
      ...
      greeting: "Bonjour 👋",
      introduction:
        "I'm Éric Vaillancourt, Senior Email Developer & Graphic Designer.",
      description: [
