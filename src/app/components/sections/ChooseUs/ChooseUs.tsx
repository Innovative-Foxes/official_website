  ...
  return (
    <CustomContainer>
      ...
      flexible layouts you can rearrange on the fly."
        ...
        />
        <Content
          description="From mobile to desktop, your landing pages never miss. From Outlook to Gmail, your emails always deliver flawlessly."
          heading={<>Blazing-fast &amp; reliable Marketer-ready templates.</>}
